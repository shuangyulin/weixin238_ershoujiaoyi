    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="父id" prop="superIds">
                       <el-input v-model="ruleForm.superIds"
                                 placeholder="父id" clearable  :readonly="ro.superIds"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="父id" prop="superIds">
                           <el-input v-model="ruleForm.superIds"
                                     placeholder="父id" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
